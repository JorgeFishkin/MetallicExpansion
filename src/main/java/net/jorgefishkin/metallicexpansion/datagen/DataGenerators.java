...
@EventBusSubscriber(modid = MetallicExpansion.MODID)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        BlockTagsProvider blockTagsProvider = new MEBlockTagProvider(packOutput, lookupProvider, existingFileHelper);
        generator.addProvider(event.includeServer(), blockTagsProvider);
        generator.addProvider(event.includeServer(), new MEItemTagProvider(packOutput, lookupProvider, blockTagsProvider.contentsGetter(), existingFileHelper));
